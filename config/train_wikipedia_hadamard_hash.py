...
out_dir = 'experiments/out-wikipedia-hadamard-hash'
eval_interval = 100
eval_iters = 100
log_interval = 20
...
n_embd = 1600         # Must be divisible by 32 for Hadamard
dropout = 0.0
bias = False
...
cooldown_lr = 1e-4              # Stage 2 peak LR (10x lower than stage 1)
