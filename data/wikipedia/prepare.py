"""
Walsh Data Engineer: Wikipedia
-------------------------------
Dataset: Wikipedia (for factual knowledge testing)
...
SUBSET_NAME = "20231101.en"  # Latest English Wikipedia snapshot

TARGET_TOKENS = 1_000_000_000 # 1 Billion Tokens
CHUNK_SIZE = 50_000_000       # Flush to disk every 50M tokens

# Output paths
os.makedirs('data/wikipedia', exist_ok=True)
TRAIN_BIN = 'data/wikipedia/train.bin'
VAL_BIN = 'data/wikipedia/val.bin'
...
print(f">>> PREPARING WIKIPEDIA ({TARGET_TOKENS/1e9}B Tokens) <<<")
